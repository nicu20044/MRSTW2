document.addEventListener("DOMContentLoaded", function() {
    ...
    playBtn.onclick = function() {
        ...
        playBtn.src = playBtn.src.includes("play.png") ? "/wwwroot/images/pause.png" : "/wwwroot/images/play.png";
    }

    stopBtn.onclick = function() {
        wavesurfer.stop();
        playBtn.src = "/wwwroot/images/play.png";
    };

    volumeBtn.onclick = function() {
        wavesurfer.toggleMute();
        volumeBtn.src = volumeBtn.src.includes("volume.png") ? "/wwwroot/images/mute.png" : "/wwwroot/images/volume.png";
    };
